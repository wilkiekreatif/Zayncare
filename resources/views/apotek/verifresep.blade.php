            ...
            <div class="col-sm-6">
              ...
              <div class="card card-default">
                <div class="card-header">
                  <div class="d-flex justify-content-between align-items-center">
                      <h3 class="card-title">
                        <a href="{{ route('apotek.resepvalidate',$trxPasien->trx_id)}}" onclick="return  confirm('Apakah anda yakin?')" class="btn btn-success btn-md" data-toggle="tooltip" data-placement="bottom" title="klik tombol ini untuk mengverifikasi Resep."> <i class="fas fa-save"> </i> Confirm Resep</a>
                      </h3>
                  </div>
                </div>
              </div>
