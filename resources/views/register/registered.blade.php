      ...
      <div class="card card-default">
          <div class="card-header">
              <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div>
                    <a href="{{ route('register.index') }}" class="btn btn-success btn-sm"> <i class="fas fa-arrow-left"> </i> Master Pasien</a>
                  </div>    
              </div>
          </div>
          <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group" style="width: 100%">
                        {{-- <a href="#" type="button" class="btn btn-sm btn-success disabled" data-toggle="tooltip" data-placement="bottom" title="Input Resep Pasien"><i class="fas fa-pills"></i></a> --}}
